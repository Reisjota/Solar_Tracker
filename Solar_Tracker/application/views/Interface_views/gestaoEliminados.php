    ...
    <div class="card">
      <div class="card-header card-header-primary">
        ...
        <ul class="nav nav-tabs" data-tabs="tabs" style="float: right !important;">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo base_url('PaginasUtilizador/gestaoEliminados');?>">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-hover">
                <?php
                  $array = array();
                  $resultadosSQL = $this->db->get('eliminados');
                  $contador = 0;
                  if ($resultadosSQL->num_rows() == 0){
                    echo "Não existem utilizadores por recuperar.";
                  }
                  else{ ?>
                  ...
                  ?>
                    ...
                    <td class="td-actions" style="text-align: center !important;">
                      ...
                      ?>
                      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal<?php echo $contador; ?>">
                      ...
                      <div class="modal fade" id="myModal<?php echo $contador;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <h5 class="modal-title">Recuperar <?php if($detalhesEmpresa['permissaoUser']==1){ echo "administrador"; } else echo "utilizador"; ?></h5>
                              <button type="button" class="close" style="width: 30px;" data-dismiss="modal" aria-hidden="true">&times;</button>
                              <h4 class="modal-title" id="myModalLabel"></h4>
                            </div>
                            <div class="modal-body">
                              Tem a certeza que pretende recuperar o utilizador <?php echo $detalhesEmpresa['nomeUser'] ?>?
                            </div>
                            <div class="modal-footer">
                              <a href="<?php echo base_url('crud/recuperar_utilizador/' . $detalhesEmpresa['idUser']); ?>"><button type="button" class="btn btn-success btn-simple">Recuperar</button></a>
